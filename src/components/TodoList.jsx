...
const TodoList = ({todos, setTodoDone, deleteTodo, archiveTodo, searchFilter, addTodo,editTodo, filter}) => (
    <div className="d-flex flex-column">
        {filter === constants.FILTER_UNDONE ? <AddTodo addTodo={addTodo}/> : ''}
        <ListGroup className="list-group p-3">
            {todos
                .filter(todo =>
                    filter === constants.FILTER_ARCHIVED ?
                        todo.archived :
                        filter === constants.FILTER_DONE ?
