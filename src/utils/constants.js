...
export const SET_TODO_ARCHIVED_START = 'SET_TODO_DONE_START';
export const SET_TODO_ARCHIVED_ERROR = 'SET_TODO_DONE_ERROR';
export const SET_TODO_ARCHIVED_SUCCESS = 'SET_TODO_DONE_SUCCESS';
